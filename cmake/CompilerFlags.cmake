...
function (add_compiler_flags)
    ...
    if (COMPILER_EMSCRIPTEN)
        ...
        if (CMAKE_BUILD_TYPE STREQUAL "Debug")
            option(XEN_EMSCRIPTEN_DEBUG_FAST_LINK "Allows to drastically speed up linking time in Debug; do not use this for an actual debug build" OFF)

            if (XEN_EMSCRIPTEN_DEBUG_FAST_LINK)
