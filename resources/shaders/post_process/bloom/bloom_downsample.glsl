...
vec3 DownsampleBox13Tap(sampler2D tex, vec2 uv, vec2 texelSize)
{
    ...
    // Apply weight distribution from Call of Duty Advanced Warfare presentation, here is an energy conserving optimized
    // way of doing it from : https://learnopengl.com/Guest-Articles/2022/Phys.-Based-Bloom
