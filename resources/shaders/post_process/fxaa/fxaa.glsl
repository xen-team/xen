...
void main()
{
    ...
    vec3 rgbA = 0.5 * (texture2D(input_texture, TexCoords + dir * ((1.0 / 3.0) - 0.5)).xyz +
                       texture2D(input_texture, TexCoords + dir * ((2.0 / 3.0) - 0.5)).xyz);
    vec3 rgbB = rgbA * 0.5 + 0.25 * (texture2D(input_texture, TexCoords + dir * -0.5).xyz +
                                     texture2D(input_texture, TexCoords + dir * 0.5).xyz);
