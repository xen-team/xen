...
enum class StateParameter : uint {
    ...
    DEPTH_TEST = static_cast<uint>(Capability::DEPTH_TEST) /* GL_DEPTH_TEST        */, ///< Depth testing.
    DEPTH_WRITEMASK = 2930 /* GL_DEPTH_WRITEMASK   */,                                 ///< Depth write mask.

    COLOR_CLEAR_VALUE = 3106 /* GL_COLOR_CLEAR_VALUE */, ///< Clear color.
#if !defined(USE_OPENGL_ES)
    COLOR_LOGIC_OP = static_cast<uint>(Capability::COLOR_LOGIC_OP) /* GL_COLOR_LOGIC_OP    */, ///<
#endif
    COLOR_WRITEMASK = 3107 /* GL_COLOR_WRITEMASK   */, ///< Color write mask.

    BLEND = static_cast<uint>(Capability::BLEND) /* GL_BLEND                */, ///< Blending.
    ...
    DITHER = static_cast<uint>(Capability::DITHER) /* GL_DITHER                     */,  ///< Dithering.
    CULL_FACE = static_cast<uint>(Capability::CULL) /* GL_CULL_FACE                  */, ///< Polygon culling.
#if !defined(USE_OPENGL_ES)
    POINT_SIZE = static_cast<uint>(Capability::POINT_SIZE) /* GL_POINT_SIZE                 */, ///< Point size.
#endif
...
enum class DepthStencilFunction : uint {
    NEVER = 512 /* GL_NEVER    */,         ///<
    EQUAL = 514 /* GL_EQUAL    */,         ///<
...
enum class StencilOperation : uint {
    ZERO = 0 /* GL_ZERO      */,               ///<
    KEEP = 7680 /* GL_KEEP      */,            ///<
...
enum class FaceOrientation : uint {
    FRONT = 1028 /* GL_FRONT          */,     ///<
    BACK = 1029 /* GL_BACK           */,      ///<
    FRONT_BACK = 1032 /* GL_FRONT_AND_BACK */ ///<
};

enum class BlendFactor : uint {
    ZERO = 0 /* GL_ZERO                     */,                         ///<
    ONE = 1 /* GL_ONE                      */,                          ///<
...
enum class PixelStorage : uint {
#if !defined(USE_OPENGL_ES)
    UNPACK_SWAP_BYTES = static_cast<uint>(StateParameter::UNPACK_SWAP_BYTES), ///<
    UNPACK_LSB_FIRST = static_cast<uint>(StateParameter::UNPACK_LSB_FIRST),   ///<
#endif
    UNPACK_ROW_LENGTH = static_cast<uint>(StateParameter::UNPACK_ROW_LENGTH),     ///<
    UNPACK_SKIP_ROWS = static_cast<uint>(StateParameter::UNPACK_SKIP_ROWS),       ///<
    UNPACK_SKIP_PIXELS = static_cast<uint>(StateParameter::UNPACK_SKIP_PIXELS),   ///<
    UNPACK_SKIP_IMAGES = static_cast<uint>(StateParameter::UNPACK_SKIP_IMAGES),   ///<
    UNPACK_IMAGE_HEIGHT = static_cast<uint>(StateParameter::UNPACK_IMAGE_HEIGHT), ///<
    UNPACK_ALIGNMENT = static_cast<uint>(StateParameter::UNPACK_ALIGNMENT),       ///<

#if !defined(USE_OPENGL_ES)
    PACK_SWAP_BYTES = static_cast<uint>(StateParameter::PACK_SWAP_BYTES), ///<
    PACK_LSB_FIRST = static_cast<uint>(StateParameter::PACK_LSB_FIRST),   ///<
#endif
    PACK_ROW_LENGTH = static_cast<uint>(StateParameter::PACK_ROW_LENGTH),     ///<
    PACK_SKIP_ROWS = static_cast<uint>(StateParameter::PACK_SKIP_ROWS),       ///<
    PACK_SKIP_PIXELS = static_cast<uint>(StateParameter::PACK_SKIP_PIXELS),   ///<
    PACK_SKIP_IMAGES = static_cast<uint>(StateParameter::PACK_SKIP_IMAGES),   ///<
    PACK_IMAGE_HEIGHT = static_cast<uint>(StateParameter::PACK_IMAGE_HEIGHT), ///<
    PACK_ALIGNMENT = static_cast<uint>(StateParameter::PACK_ALIGNMENT)        ///<
};

enum class AttribDataType : uint {
...
enum class BufferDataUsage : uint {
...
enum class TextureParamValue : uint {
...
enum class TextureAttribute : uint {
...
enum class TextureInternalFormat : uint {
    // Base formats
    RED = static_cast<uint>(TextureFormat::RED),
    RG = static_cast<uint>(TextureFormat::RG),
    RGB = static_cast<uint>(TextureFormat::RGB),
    BGR = static_cast<uint>(TextureFormat::BGR),
    RGBA = static_cast<uint>(TextureFormat::RGBA),
    BGRA = static_cast<uint>(TextureFormat::BGRA),
    SRGB = static_cast<uint>(TextureFormat::SRGB),
    DEPTH = static_cast<uint>(TextureFormat::DEPTH),
    DEPTH_STENCIL = static_cast<uint>(TextureFormat::DEPTH_STENCIL),
...
#if !defined(USE_OPENGL_ES)
    R8 = static_cast<uint>(TextureInternalFormat::R8),   ///<
    RG8 = static_cast<uint>(TextureInternalFormat::RG8), ///<
#endif
    RGBA8 = static_cast<uint>(TextureInternalFormat::RGBA8), ///<
#if !defined(USE_OPENGL_ES)
    R8I = static_cast<uint>(TextureInternalFormat::R8I),   ///<
    RG8I = static_cast<uint>(TextureInternalFormat::RG8I), ///<
#endif
    RGBA8I = static_cast<uint>(TextureInternalFormat::RGBA8I), ///<
#if !defined(USE_OPENGL_ES)
    R8UI = static_cast<uint>(TextureInternalFormat::R8UI),   ///<
    RG8UI = static_cast<uint>(TextureInternalFormat::RG8UI), ///<
#endif
    RGBA8UI = static_cast<uint>(TextureInternalFormat::RGBA8UI), ///<
#if !defined(USE_OPENGL_ES)
    R8_SNORM = static_cast<uint>(TextureInternalFormat::R8_SNORM),   ///<
    RG8_SNORM = static_cast<uint>(TextureInternalFormat::RG8_SNORM), ///<
#endif
    RGBA8_SNORM = static_cast<uint>(TextureInternalFormat::RGBA8_SNORM), ///<

#if !defined(USE_OPENGL_ES)
    R16 = static_cast<uint>(TextureInternalFormat::R16),       ///<
    RG16 = static_cast<uint>(TextureInternalFormat::RG16),     ///<
    RGBA16 = static_cast<uint>(TextureInternalFormat::RGBA16), ///<
    R16I = static_cast<uint>(TextureInternalFormat::R16I),     ///<
    RG16I = static_cast<uint>(TextureInternalFormat::RG16I),   ///<
#endif
    RGBA16I = static_cast<uint>(TextureInternalFormat::RGBA16I), ///<
#if !defined(USE_OPENGL_ES)
    R16UI = static_cast<uint>(TextureInternalFormat::R16UI),   ///<
    RG16UI = static_cast<uint>(TextureInternalFormat::RG16UI), ///<
#endif
    RGBA16UI = static_cast<uint>(TextureInternalFormat::RGBA16UI), ///<
#if !defined(USE_OPENGL_ES)
    R16F = static_cast<uint>(TextureInternalFormat::R16F),   ///<
    RG16F = static_cast<uint>(TextureInternalFormat::RG16F), ///<
#endif
    RGBA16F = static_cast<uint>(TextureInternalFormat::RGBA16F), ///<
#if !defined(USE_OPENGL_ES)
    R16_SNORM = static_cast<uint>(TextureInternalFormat::R16_SNORM),       ///<
    RG16_SNORM = static_cast<uint>(TextureInternalFormat::RG16_SNORM),     ///<
    RGBA16_SNORM = static_cast<uint>(TextureInternalFormat::RGBA16_SNORM), ///<
#endif

    R32I = static_cast<uint>(TextureInternalFormat::R32I), ///<
#if !defined(USE_OPENGL_ES)
    RG32I = static_cast<uint>(TextureInternalFormat::RG32I), ///<
#endif
    RGBA32I = static_cast<uint>(TextureInternalFormat::RGBA32I), ///<
    R32UI = static_cast<uint>(TextureInternalFormat::R32UI),     ///<
#if !defined(USE_OPENGL_ES)
    RG32UI = static_cast<uint>(TextureInternalFormat::RG32UI), ///<
#endif
    RGBA32UI = static_cast<uint>(TextureInternalFormat::RGBA32UI), ///<
    R32F = static_cast<uint>(TextureInternalFormat::R32F),         ///<
#if !defined(USE_OPENGL_ES)
    RG32F = static_cast<uint>(TextureInternalFormat::RG32F), ///<
#endif
    RGBA32F = static_cast<uint>(TextureInternalFormat::RGBA32F), ///<

#if !defined(USE_OPENGL_ES)
    RGB10_A2 = static_cast<uint>(TextureInternalFormat::RGB10_A2),            ///<
    RGB10_A2UI = static_cast<uint>(TextureInternalFormat::RGB10_A2UI),        ///<
    R11F_G11F_B10F = static_cast<uint>(TextureInternalFormat::R11F_G11F_B10F) ///<
#endif
};

enum class ProgramParameter : uint {
...
enum class FramebufferAttachmentParam : uint {
...
enum class ReadBuffer : uint {
    ...
    FRONT_LEFT = static_cast<uint>(FramebufferAttachment::DEFAULT_FRONT_LEFT),   ///<
    FRONT_RIGHT = static_cast<uint>(FramebufferAttachment::DEFAULT_FRONT_RIGHT), ///<
    BACK_LEFT = static_cast<uint>(FramebufferAttachment::DEFAULT_BACK_LEFT),     ///<
    BACK_RIGHT = static_cast<uint>(FramebufferAttachment::DEFAULT_BACK_RIGHT),   ///<
#endif

    COLOR_ATTACHMENT0 = static_cast<uint>(FramebufferAttachment::COLOR0), ///< Color attachment 0.
    COLOR_ATTACHMENT1 = static_cast<uint>(FramebufferAttachment::COLOR1), ///< Color attachment 1.
    COLOR_ATTACHMENT2 = static_cast<uint>(FramebufferAttachment::COLOR2), ///< Color attachment 2.
    COLOR_ATTACHMENT3 = static_cast<uint>(FramebufferAttachment::COLOR3), ///< Color attachment 3.
    COLOR_ATTACHMENT4 = static_cast<uint>(FramebufferAttachment::COLOR4), ///< Color attachment 4.
    COLOR_ATTACHMENT5 = static_cast<uint>(FramebufferAttachment::COLOR5), ///< Color attachment 5.
    COLOR_ATTACHMENT6 = static_cast<uint>(FramebufferAttachment::COLOR6), ///< Color attachment 6.
    COLOR_ATTACHMENT7 = static_cast<uint>(FramebufferAttachment::COLOR7)  ///< Color attachment 7.
};

enum class DrawBuffer : uint {
    NONE = static_cast<uint>(ReadBuffer::NONE), ///<
    ...
    BACK_RIGHT = static_cast<uint>(FramebufferAttachment::DEFAULT_BACK_RIGHT),   ///<
#else
    BACK = static_cast<uint>(ReadBuffer::BACK), ///<
#endif
...
enum class BlitFilter : uint {
    NEAREST = static_cast<uint>(TextureParamValue::NEAREST), ///<
    LINEAR = static_cast<uint>(TextureParamValue::LINEAR)    ///<
};
...
enum class RegionBarrierType : uint {
    ATOMIC_COUNTER = static_cast<uint>(BarrierType::ATOMIC_COUNTER),           ///<
    FRAMEBUFFER = static_cast<uint>(BarrierType::FRAMEBUFFER),                 ///<
    SHADER_IMAGE_ACCESS = static_cast<uint>(BarrierType::SHADER_IMAGE_ACCESS), ///<
    SHADER_STORAGE = static_cast<uint>(BarrierType::SHADER_STORAGE),           ///<
    TEXTURE_FETCH = static_cast<uint>(BarrierType::TEXTURE_FETCH),             ///<
    UNIFORM = static_cast<uint>(BarrierType::UNIFORM),                         ///<
    ALL = static_cast<uint>(BarrierType::ALL)                                  ///<
};
...
enum class RenderObjectType : uint {
    ...
    FRAMEBUFFER = static_cast<uint>(FramebufferType::FRAMEBUFFER) /* GL_FRAMEBUFFER        */, ///<
...
struct ErrorCodes {
    ...
    {
        return codes[static_cast<uint>(code) - static_cast<uint>(ErrorCode::INVALID_ENUM)];
    }
...
public:
    ...
    static void get_parameter(StateParameter parameter, uint index, unsigned char* values);
    static void get_parameter(StateParameter parameter, uint index, int* values);
    static void get_parameter(StateParameter parameter, uint index, int64_t* values);
    ...
    static void set_stencil_function(
        DepthStencilFunction func, int ref, uint mask, FaceOrientation orientation = FaceOrientation::FRONT_BACK
    );
    ...
    static void set_stencil_mask(uint mask, FaceOrientation orientation = FaceOrientation::FRONT_BACK);
...
#endif
    static void set_pixel_storage(PixelStorage storage, uint value);
    static void recover_frame(Vector2ui const& size, TextureFormat format, PixelDataType data_type, void* data);
    static void generate_vertex_arrays(uint count, uint* indices);
    static void generate_vertex_array(uint& index) { generate_vertex_arrays(1, &index); }
    static void bind_vertex_array(uint index);
    ...
    static void set_vertex_attrib(
        uint index, AttribDataType data_type, uint8_t size, uint stride, uint offset, bool normalize = false
    );
    static void set_vertex_attribDivisor(uint index, uint divisor);
    static void delete_vertex_arrays(uint count, uint* indices);
    static void delete_vertex_array(uint& index) { delete_vertex_arrays(1, &index); }
    static void generate_buffers(uint count, uint* indices);
    template <size_t N>
    static void generate_buffers(uint (&indices)[N])
    {
        generate_buffers(N, indices);
    }
    static void generate_buffer(uint& index) { generate_buffers(1, &index); }
    static void bind_buffer(BufferType type, uint index);
    static void unbind_buffer(BufferType type) { bind_buffer(type, 0); }
    static void bind_buffer_base(BufferType type, uint binding_index, uint buffer_index);
    ...
    static void delete_buffers(uint count, uint* indices);
    template <size_t N>
    static void delete_buffers(uint (&indices)[N])
    {
        delete_buffers(N, indices);
    }
    static void delete_buffer(uint& index) { delete_buffers(1, &index); }
    static bool is_texture(uint index);
    static void generate_textures(uint count, uint* indices);
    template <size_t N>
    static void generate_textures(uint (&indices)[N])
    {
        generate_textures(N, indices);
    }
    static void generate_texture(uint& index) { generate_textures(1, &index); }
    static void bind_texture(TextureType type, uint index);
    static void unbind_texture(TextureType type) { bind_texture(type, 0); }
#if !defined(USE_WEBGL)
    static void bind_image_texture(
        uint image_unit_index, uint texture_index, int texture_level, bool is_layered, int layer,
        ImageAccess image_access, ImageInternalFormat image_format
    );
#endif
    static void activate_texture(uint index);
    ...
    /// \param param Parameter to set.
    /// \param value Value to be set.
    static void set_texture_parameter(uint texture_index, TextureParam param, int value);
    /// Sets a parameter to the given texture.
    /// \note Requires OpenGL 4.5+.
    /// \param texture_index Index of the texture to set the parameter to.
    /// \param param Parameter to set.
    /// \param value Value to be set.
    static void set_texture_parameter(uint texture_index, TextureParam param, float value);
    /// Sets a parameter to the given texture.
    /// \note Requires OpenGL 4.5+.
    /// \param texture_index Index of the texture to set the parameter to.
    /// \param param Parameter to set.
    /// \param values Values to be set.
    static void set_texture_parameter(uint texture_index, TextureParam param, int const* values);
    /// Sets a parameter to the given texture.
    /// \note Requires OpenGL 4.5+.
    /// \param texture_index Index of the texture to set the parameter to.
    /// \param param Parameter to set.
    /// \param values Values to be set.
    static void set_texture_parameter(uint texture_index, TextureParam param, float const* values);
    /// Sets a parameter to the given texture.
    /// \note Requires OpenGL 4.5+.
    /// \param texture_index Index of the texture to set the parameter to.
    /// \param param Parameter to set.
    /// \param value Value to be set.
    static void set_texture_parameter(uint texture_index, TextureParam param, TextureParamValue value)
    {
...
#if !defined(USE_OPENGL_ES)
    static void recover_texture_attribute(TextureType type, uint mipmap_level, TextureAttribute attribute, int* values);
    static void
    recover_texture_attribute(TextureType type, uint mipmap_level, TextureAttribute attribute, float* values);
    static int recover_texture_width(TextureType type, uint mipmap_level = 0);
    static int recover_texture_height(TextureType type, uint mipmap_level = 0);
    static int recover_texture_depth(TextureType type, uint mipmap_level = 0);
    static TextureInternalFormat recover_texture_internal_format(TextureType type, uint mipmap_level = 0);
    ...
    static void generate_mipmap(uint texture_index);
#endif
    static void delete_textures(uint count, uint* indices);
    template <size_t N>
    static void delete_textures(uint (&indices)[N])
    {
        delete_textures(N, indices);
    }
    static void delete_texture(uint& index) { delete_textures(1, &index); }
    static void resize_viewport(Vector2ui const& position, Vector2ui const& size);
    static uint create_program();
    static void get_program_parameter(uint index, ProgramParameter parameter, int* parameters);
    static bool is_program_linked(uint index);
    static uint recover_active_uniform_count(uint program_index);
    static std::vector<uint> recover_attached_shaders(uint program_index);
    static void link_program(uint index);
    static void use_program(uint index);
    static void delete_program(uint index);
    static uint create_shader(ShaderType type);
    static int recover_shader_info(uint index, ShaderInfo info);
    static ShaderType recover_shader_type(uint index)
    {
        return static_cast<ShaderType>(recover_shader_info(index, ShaderInfo::TYPE));
    }
    static bool is_shader_compiled(uint index) { return (recover_shader_info(index, ShaderInfo::COMPILE_STATUS) == 1); }
    static void send_shader_source(uint index, char const* source, int length);
    static void send_shader_source(uint index, std::string const& source)
    {
        send_shader_source(index, source.c_str(), static_cast<int>(source.size()));
    }
    static void send_shader_source(uint index, std::string_view source)
    {
        send_shader_source(index, source.data(), static_cast<int>(source.size()));
    }
    static std::string recover_shader_source(uint index);
    static void compile_shader(uint index);
    static void attach_shader(uint program_index, uint shader_index);
    static void detach_shader(uint program_index, uint shader_index);
    static bool is_shader_attached(uint program_index, uint shader_index);
    static void delete_shader(uint index);
    ...
    static int recover_uniform_location(uint program_index, char const* uniform_name);
    ...
    static void recover_uniform_info(
        uint program_index, uint uniform_index, UniformType& type, std::string& name, int* size = nullptr
    );
    static UniformType recover_uniform_type(uint program_index, uint uniform_index);
    static std::string recover_uniform_name(uint program_index, uint uniform_index);
    static void recover_uniform_data(uint program_index, int uniform_index, int* data);
    static void recover_uniform_data(uint program_index, int uniform_index, uint* data);
    static void recover_uniform_data(uint program_index, int uniform_index, float* data);
#if !defined(USE_OPENGL_ES)
    static void recover_uniform_data(uint program_index, int uniform_index, double* data);
#endif
    static void bind_uniform_block(uint program_index, uint uniform_block_index, uint binding_index);
    static uint recover_uniform_block_index(uint program_index, char const* uniform_name);
    ...
    static void send_uniform(int uniform_index, uint value);
    ...
    /// \param values Array of values to be sent.
    /// \param count Number of vectors to be sent.
    static void send_uniform_vector1fui(int uniform_index, uint const* values, int count = 1);
    /// Sends an uinteger 2D vector as uniform.
    /// \param uniform_index Index of the uniform to send the data to.
    /// \param values Array of values to be sent.
    /// \param count Number of vectors to be sent.
    static void send_uniform_Vector2ui(int uniform_index, uint const* values, int count = 1);
    /// Sends an uinteger 3D vector as uniform.
    /// \param uniform_index Index of the uniform to send the data to.
    /// \param values Array of values to be sent.
    /// \param count Number of vectors to be sent.
    static void send_uniform_Vector3ui(int uniform_index, uint const* values, int count = 1);
    /// Sends an uinteger 4D vector as uniform.
    /// \param uniform_index Index of the uniform to send the data to.
    /// \param values Array of values to be sent.
    /// \param count Number of vectors to be sent.
    static void send_uniform_Vector4ui(int uniform_index, uint const* values, int count = 1);
    ...
    static void generate_framebuffers(int count, uint* indices);
    template <size_t N>
    static void generate_framebuffers(uint (&indices)[N])
    {
        generate_framebuffers(N, indices);
    }
    static void generate_framebuffer(uint& index) { generate_framebuffers(1, &index); }
    static void bind_framebuffer(uint index, FramebufferType type = FramebufferType::FRAMEBUFFER);
    ...
    static void set_framebuffer_texture(
        FramebufferAttachment attachment, uint texture_index, uint mipmap_level,
    ...
    static void set_framebuffer_texture_3d(
        FramebufferAttachment attachment, uint texture_index, uint mipmap_level, uint layer,
        FramebufferType type = FramebufferType::FRAMEBUFFER
    );
#endif
    ...
    static void set_draw_buffers(uint count, DrawBuffer const* buffers);
    template <size_t N>
    ...
    static void delete_framebuffers(uint count, uint* indices);
    template <size_t N>
    static void delete_framebuffers(uint (&indices)[N])
    {
        delete_framebuffers(N, indices);
    }
    static void deleteFramebuffer(uint& index) { delete_framebuffers(1, &index); }
    static void draw_arrays(PrimitiveType type, uint first, uint count);
    static void draw_arrays(PrimitiveType type, uint count) { draw_arrays(type, 0, count); }
    static void draw_arrays_instanced(PrimitiveType type, uint first, uint primitive_count, uint instance_count);
    static void draw_arrays_instanced(PrimitiveType type, uint primitive_count, uint instance_count)
    {
        draw_arrays_instanced(type, 0, primitive_count, instance_count);
    }
    static void draw_elements(PrimitiveType type, uint count, ElementDataType data_type, void const* indices);
    static void draw_elements(PrimitiveType type, uint count, uint8_t const* indices)
    {
        draw_elements(type, count, ElementDataType::UBYTE, indices);
    }
    static void draw_elements(PrimitiveType type, uint count, unsigned short const* indices)
    {
        draw_elements(type, count, ElementDataType::USHORT, indices);
    }
    static void draw_elements(PrimitiveType type, uint count, uint const* indices)
    {
        draw_elements(type, count, ElementDataType::UINT, indices);
    }
    static void draw_elements(PrimitiveType type, uint count)
    {
    ...
    static void
    draw_elements_instanced(PrimitiveType type, uint primitive_count, uint8_t const* indices, uint instance_count)
    {
        draw_elements_instanced(type, primitive_count, ElementDataType::UBYTE, indices, instance_count);
    }
    static void draw_elements_instanced(
        PrimitiveType type, uint primitive_count, unsigned short const* indices, uint instance_count
    )
    {
        draw_elements_instanced(type, primitive_count, ElementDataType::USHORT, indices, instance_count);
    }
    static void
    draw_elements_instanced(PrimitiveType type, uint primitive_count, uint const* indices, uint instance_count)
    {
        draw_elements_instanced(type, primitive_count, ElementDataType::UINT, indices, instance_count);
    }
    static void draw_elements_instanced(PrimitiveType type, uint primitive_count, uint instance_count)
    {
    ...
    static void generate_queries(uint count, uint* indices);

    static void generate_query(uint& index) { generate_queries(1, &index); }

    static void begin_query(QueryType type, uint index);

    static void end_query(QueryType type);

#if !defined(USE_OPENGL_ES)
    static void recover_query_result(uint index, int64_t& result);

    static void recover_query_result(uint index, uint64_t& result);
#endif
    static void delete_queries(uint count, uint* indices);

    static void delete_query(uint& index) { delete_queries(1, &index); }
    ...
    static void set_label(RenderObjectType type, uint object_index, char const* label);
    ...
    static void set_label(RenderObjectType type, uint object_index, std::string const& label)
    {
    ...
    static void reset_label(RenderObjectType type, uint object_index) { set_label(type, object_index, nullptr); }
    ...
    static std::string recover_label(RenderObjectType type, uint object_index);
