...
enum State {
    ...
    HIDDEN = 212994 /* GLFW_CURSOR_HIDDEN   */,  ///< The cursor stays hidden but exists nonetheless, so that it can
                                                 ///< freely go out of the window.
    DISABLED = 212995 /* GLFW_CURSOR_DISABLED */ ///< The cursor stays hidden while continuously returning to the
                                                 ///< center, so that it can't go out of the window.
};
}
}