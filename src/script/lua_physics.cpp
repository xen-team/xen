...
void LuaWrapper::register_physics_types()
{
    ...
    // {
    //     sol::usertype<PhysicsSystemSystem> physicsSystem = state.new_usertype<PhysicsSystemSystem>(
    //         "PhysicsSystemSystem", sol::constructors<PhysicsSystemSystem()>(), sol::base_classes,
    //         sol::bases<System>()
    //     );
    //     physicsSystem["gravity"] = sol::property(&PhysicsSystemSystem::get_gravity,
    //     &PhysicsSystemSystem::set_gravity); physicsSystem["friction"] =
    //     sol::property(&PhysicsSystemSystem::get_friction, &PhysicsSystemSystem::set_friction);
    // }
