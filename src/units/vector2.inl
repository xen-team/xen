...
template <typename T>
template <typename U>
auto Vector2<T>::rotate(U const& angle) const
{
...
template <typename T>
template <typename U, typename V>
auto Vector2<T>::rotate(U const& angle, Vector2<V> const& rotationAxis) const
{
...
template <typename T>
template <typename U>
auto Vector2<T>::distance(Vector2<U> const& other) const
{
