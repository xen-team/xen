...
template <>
Vector2f const Vector2f::infinity(std::numeric_limits<float>::infinity());
template <>
...
template <>
Vector2d const Vector2d::infinity(std::numeric_limits<double>::infinity());
template <>
...
template <>
Vector2i const Vector2i::infinity(std::numeric_limits<int32_t>::infinity());
template <>
