...
) : rows{{{m00, m10, m20, m30}, {m01, m11, m21, m31}, {m02, m12, m22, m32}, {m03, m13, m23, m33}}} {};
...
constexpr Matrix4::Matrix4(std::array<row_t, Count> src) : rows{std::move(src)} {};
...
constexpr Matrix4 Matrix4::scaling(Vector3f const& scale)
{
