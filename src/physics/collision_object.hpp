...
namespace xen {
class Frustum;
class XEN_API CollisionObject : public virtual rocket::trackable, NonCopyable {
...
public:
    rocket::signal<void(CollisionObject*)> on_collision;
    rocket::signal<void(CollisionObject*)> on_separation;
...
public:
    ...
    {
        ar(colliders, mass, friction, friction_rolling, friction_spinning);
    }
    template <class Archive>
